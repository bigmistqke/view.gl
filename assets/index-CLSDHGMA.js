...
const __vite_glob_0_0 = ""+new URL('bezier-5-yFAhLY.ts', import.meta.url).href+"";

const __vite_glob_0_1 = ""+new URL('game_of_life-BXh3ahRX.ts', import.meta.url).href+"";

const __vite_glob_0_2 = ""+new URL('grid-CezNVJ5a.ts', import.meta.url).href+"";
...
const __vite_glob_0_4 = ""+new URL('pix_sim-e4S36zod.ts', import.meta.url).href+"";
...
const __vite_glob_0_6 = ""+new URL('tetris-DTN16P8_.ts', import.meta.url).href+"";
