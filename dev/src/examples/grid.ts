...
window.addEventListener(
  ...
  event => {
    ...
    // Calculate the grid coordinate under the mouse cursor before scaling
    ...
    // Adjust offset to keep the grid coordinate under the cursor
...
// Vertex shader - maps grid to screen space anchored at top-left
...
} = compile(gl, vertex, renderFragment)
...
function render() {
  ...
  // Pass grid parameters to shaders
